...
const TECH_META = {
  "React.js": {
    icon: SiReact,
    color: "text-[#89b4fa]", // Mocha Blue
    ring: "border-[#89b4fa]/30 bg-[#89b4fa]/10",
  },
  "Tailwind CSS": {
    icon: SiTailwindcss,
    color: "text-[#89dceb]", // Mocha Sky
    ring: "border-[#89dceb]/30 bg-[#89dceb]/10",
  },
  Supabase: {
    icon: SiSupabase,
    color: "text-[#a6e3a1]", // Mocha Green
    ring: "border-[#a6e3a1]/30 bg-[#a6e3a1]/10",
  },
  "Context API": {
    icon: BiCodeCurly,
    color: "text-[#cba6f7]", // Mocha Mauve
    ring: "border-[#cba6f7]/30 bg-[#cba6f7]/10",
  },
  "CoinGecko API": {
    icon: TbApi,
    color: "text-[#f9e2af]", // Mocha Yellow
    ring: "border-[#f9e2af]/30 bg-[#f9e2af]/10",
  },
  "React Router": {
    icon: SiReactrouter,
    color: "text-[#f38ba8]", // Mocha Red
    ring: "border-[#f38ba8]/30 bg-[#f38ba8]/10",
  },
};
...
const projectsData = [
  ...
  },
  {
    ...
    liveLink:
      "https://www.linkedin.com/posts/hrushikeshj26_reactjs-tailwindcss-supabase-ugcPost-7469005036220530688-cKyO",
      ...
      <div className="relative aspect-video overflow-hidden bg-surface border-b border-subtle group-hover:border-second transition-colors duration-300">
        ...
        >
          <motion.span
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center gap-1.5 bg-[#f38ba8] text-white text-xs font-bold px-4 py-2 rounded-full translate-y-4 group-hover:translate-y-0 transition-all duration-300 shadow-lg border border-second/50"
          >
            Live Demo
      ...
      <div className="px-6 md:px-10 lg:px-12 relative z-10 -mt-16 sm:-mt-20 mb-12">
        <div className="border-2 border-second rounded-2xl p-7 sm:p-10 shadow-2xl backdrop-blur-3xl max-w-4xl">
          ...
          <p className="text-gray-400 text-sm sm:text-base leading-relaxed max-w-2xl">
            A collection of full-stack apps and tools I've built end to end —
            from database schema to the pixel on screen. Each one shipped with
            real users and real edge cases in mind.
          </p>
        </div>
      </div>
